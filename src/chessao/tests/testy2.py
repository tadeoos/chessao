...
# 	r = gameplay.rozgrywka(fenrep=boot[0], ovr=[boot[1][0],boot[1][1]], test=True)
# 	# print(r)
...
# 		roz = gameplay.rozgrywka(fenrep=frep, ovr=([card],[]))
